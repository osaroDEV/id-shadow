...
const DashboardNavbar = () => {
  return (
    <div className='flex items-center justify-between border-b-2 px-8 h-[5rem] relative bg-white'>
      ...
      <div className='flex gap-8'>
        ...
        <button className='text-sm text-white font-semibold bg-blue-base px-[1.25rem] rounded-md h-[2.5rem]'>
          Start a new company
        </button>
      </div>
    </div>
